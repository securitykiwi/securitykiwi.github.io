...
<div style="text-align:center;"><img src="/assets/images/convolutional-neural-network-diagram" alt="A diagram of a convolutional neural network." style="width:500px;"/></div>
